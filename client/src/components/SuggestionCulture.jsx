...
import { FiChevronDown, FiChevronUp, FiEye, FiZap, FiX } from "react-icons/fi";
import { useSocket } from '../context/SocketContext.jsx'
import { useUser } from '../context/UserContext.jsx'

const SuggestionCulture = ({ c, viewMode = 'grid' }) => {
    ...
    const toggleComment = (report_id) => {
        ...
        // Note: You'll need to implement getComments function similar to CultureList
    };
    ...
    return (
        <div className={`w-full bg-gradient-to-br from-white to-[#FFF1D6] shadow-md rounded-xl border border-[#FF8800] transition-all duration-200 hover:shadow-lg ${
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    <div className="relative">
                        <img
                            className="h-10 w-10 rounded-full object-cover border-2 border-[#FF8800]"
                            src={c.user_image_url || "https://thispersondoesnotexist.com"} 
                            alt="AI Suggestion" 
                        />
                        <div className="absolute -top-1 -right-1 bg-[#FF8800] rounded-full p-1">
                            <FiZap className="w-3 h-3 text-white" />
                        </div>
                    </div>
                    <div>
                        <p className="font-semibold text-[#800000] capitalize">
                            AI Suggestion
                        </p>
